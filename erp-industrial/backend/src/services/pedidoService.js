...
export const pedidoService = {
  async createFromOrcamento(orcamentoId) {
    ...
    if (orcamento.status !== 'aprovado')
      throw httpError('Somente orçamento aprovado gera pedido');

    const pedido = await pedidoRepository.createFromOrcamento(
      orcamento,
      orcamento.itens,
    );
